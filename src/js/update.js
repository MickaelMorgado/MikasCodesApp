...
const updateOptions = {
  gitRepo: 'MickaelMorgado', // [Required] Your Repo Name
  gitUsername: 'MickaelMorgado', // [Required] Your GitHub Username.

  appName: 'MikasCodesApp', //[Required] The Name of the app archive and the app folder.
  appExecutableName: 'MikasCodesApp.exe', //[Required] The Executable of the Application to be Run after updating.
